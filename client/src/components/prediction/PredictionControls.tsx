...
/**
 * Admin/Super Admin-only lifecycle controls. Gated here, in one place,
 * rather than by every call site remembering to check the role — a
 * regular viewer (or a logged-out visitor) simply never sees this
 * component render anything. The server enforces the same boundary
 * independently (requireRole on the write routes), so this is a UI
