...
export function migrate() {
  ...
  // Idempotent column migration: a database created before the `role`
  // column existed (e.g. an already-deployed Render instance) needs it
  // added explicitly — CREATE TABLE IF NOT EXISTS above only affects
  // brand-new databases, not existing ones.
